...
//          testingJavaCollectionsAssertJ(colors);
    ...
    public static int sum(int a, int b) {
        assert a < (Integer.MAX_VALUE - b) : "Ошибка, результат вышел за пределы int";
        return a + b;
    }
...
//        String currentDateTime = dateFormat.format(calendar.getTime());
        ...
        Calendar newYear = new GregorianCalendar(2023, Calendar.OCTOBER, 11, 23, 40);

        System.out.println(now.compareTo(newYear));

//        assert currentDateTime.equals("11/10/2023 23:29:44") : "Еще 2023 год :(";
        assert now.compareTo(newYear) > 0 : "Еще 2023 год :(";
    ...
    public static void checkingHero() {
        ...
        */
        ...
        assertThat(emmett.getName()).isNotNull().isEqualTo("Emmett");
